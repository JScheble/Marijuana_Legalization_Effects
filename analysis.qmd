---
title: "Impact of Marijuana Legalization on Usage Rates"
author:
  - name: Anish Poudel
  - name: Cooper Scheble
  - name: Joseph Pelkey
...
```{r}
write_csv(full_df, "merged_marijuana_data.csv")
```
